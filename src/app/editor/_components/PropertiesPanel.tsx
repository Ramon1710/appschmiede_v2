...
export default function PropertiesPanel({
  ...
  if (!node) {
    return (
      <div className="w-80 bg-[#161618] border-l border-[#222] p-4 text-sm text-gray-400">
    ...
    <div className="w-80 bg-[#161618] border-l border-[#222] p-4">
      ...
      <div className="space-y-3 text-sm">
        <div>
          ...
          <div className="px-2 py-1 bg-[#202226] rounded">{node.type}</div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <label className="block">
            ...
            <input
              type="number"
              className="w-full bg-[#0f1113] border border-[#2a2d31] rounded px-2 py-1"
              value={node.x ?? 0}
              onChange={(e) => updateNode({ x: parseInt(e.target.value || "0", 10) })}
            />
          </label>
          <label className="block">
            ...
            <input
              ...
              className="w-full bg-[#0f1113] border border-[#2a2d31] rounded px-2 py-1"
              value={node.y ?? 0}
              onChange={(e) => updateNode({ y: parseInt(e.target.value || "0", 10) })}
            />
          </label>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <label className="block">
            <span className="text-xs text-gray-400">Breite</span>
            <input
              type="number"
              className="w-full bg-[#0f1113] border border-[#2a2d31] rounded px-2 py-1"
              value={node.w ?? ""}
              onChange={(e) => updateNode({ w: e.target.value ? parseInt(e.target.value, 10) : undefined })}
            />
          </label>
          <label className="block">
            ...
            <input
              ...
              className="w-full bg-[#0f1113] border border-[#2a2d31] rounded px-2 py-1"
              value={node.h ?? ""}
              onChange={(e) => updateNode({ h: e.target.value ? parseInt(e.target.value, 10) : undefined })}
            />
          </label>
        </div>
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-2">
              <label className="block">
                ...
                <input
                  type="color"
                  className="w-full bg-[#0f1113] border border-[#2a2d31] rounded h-9"
              ...
              <label className="block">
                ...
                <input
                  ...
                  onChange={(e) => setProp("fontSize", parseInt(e.target.value || "16", 10))}
                />
              </label>
            </div>
            <label className="block">
        ...
        {node.type === "image" && (
          <>
            <label className="block">
              <span className="text-xs text-gray-400">Bild-URL</span>
              <input
                className="w-full bg-[#0f1113] border border-[#2a2d31] rounded px-2 py-1"
          ...
          <>
            ...
            <label className="block">
              ...
              <input
                ...
                className="w-full bg-[#0f1113] border border-[#2a2d31] rounded px-2 py-1"
                value={node.w ?? 220}
                onChange={(e) => updateNode({ w: parseInt(e.target.value || "220", 10) })}
              />
            </label>
          </>
        )}
